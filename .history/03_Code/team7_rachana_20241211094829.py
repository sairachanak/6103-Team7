...
def logistic_regression_optimized():
    """
    Train and evaluate an optimized logistic regression model with feature selection and class weight.
    """
    ...
    rfe = RFE(estimator=logit_model, n_features_to_select=10)
    ...
    y_pred_prob = logit_model.predict_proba(X_test_rfe)[:, 1]
